...
class MiniGPT4(MiniGPTBase):
    ...
    def __init__(
            ...
            q_former_model="/mnt/e/checkpoints/blip2_pretrained_flant5xxl.pth",
            img_size=224,
            drop_path_rate=0,
    ...
    def init_Qformer(cls, num_query_token, vision_width, freeze):
        encoder_config = BertConfig.from_pretrained("/mnt/e/save_models/bert-base-uncased")
    ...
    def from_config(cls, cfg):
        ...
        q_former_model = cfg.get("q_former_model", "/mnt/e/checkpoints/blip2_pretrained_flant5xxl.pth")
